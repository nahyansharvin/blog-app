...
authRouter.post('/signup', async (c) => {
  ...
  try {
    ...
    setCookie(c, COOKIES.AUTHORIZATION, token, { httpOnly: true, sameSite: 'None', secure: true, maxAge: 86400 })
...
authRouter.post('/signout', async (c) => {
  deleteCookie(c, COOKIES.AUTHORIZATION, {secure: true, sameSite: 'None' } )
